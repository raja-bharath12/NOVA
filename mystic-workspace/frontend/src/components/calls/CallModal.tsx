            ...
            >
                ...
                <div className="flex items-center gap-3 min-w-0">
                  <div
                    className={`h-3 w-3 rounded-full flex-shrink-0 ${
                      activeCall.status === 'CONNECTED' ? 'bg-emerald-400 animate-pulseGlow' : 'bg-amber-400 animate-pulse'
                    }`}
                  />
              ...
              <div className="relative z-10 flex items-center justify-center gap-4 sm:gap-6 py-4 sm:py-5 px-6 border-t border-white/[0.08] bg-void-950/95 md:bg-void-950/60 backdrop-blur-xl pb-[max(1.75rem,env(safe-area-inset-bottom))] flex-shrink-0">
                <button
                  type="button"
                  onClick={toggleMic}
                  className={`h-12 w-12 sm:h-14 sm:w-14 rounded-full flex items-center justify-center transition-all ${
                    isMicMuted
